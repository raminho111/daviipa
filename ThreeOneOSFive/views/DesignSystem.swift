...
enum AppTheme {
    static let accent = Color(
        uiColor: UIColor(red: 0.486, green: 0.227, blue: 0.929, alpha: 1.00)
    )
...
struct AppPressableButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .animation(.easeOut(duration: AppTheme.motionDuration), value: configuration.isPressed)
    }
}
...
struct AppLogo: View {
    ...
    var body: some View {
        Group {
            if let icon = UIImage(named: "Bypass7Logo")
